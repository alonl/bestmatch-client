...
public class MatchAdapterBottom extends FragmentPagerAdapter implements ViewPager.OnPageChangeListener {
	...
	public MatchAdapterBottom(MainActivity context, FragmentManager fm, ArrayList<Match> data) {
		super(fm);
		this.fm = fm;
	...
	private String getFragmentTag(int position) {
		return "android:switcher:" + context.bottomPageViewer.getId() + ":" + position;
	}
}